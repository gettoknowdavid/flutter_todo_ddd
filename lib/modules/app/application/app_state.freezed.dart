...
class _$_AppState implements _AppState {
  const _$_AppState({required this.user, required this.loading});
  ...
  @override
  String toString() {
    return 'AppState(user: $user, loading: $loading)';
  }
...
abstract class _AppState implements AppState {
  const factory _AppState(
      {required final User? user, required final bool loading}) = _$_AppState;
